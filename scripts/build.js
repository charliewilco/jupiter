...
if &background ==# "light"
${vimThemeBlock(Metis.themes.light)}
else
${vimThemeBlock(Metis.themes.dark)}
endif`;
}
...
let s:V1 = [ "${ui.background}" , "${colors.magenta}" , "" , "" ]
...
let g:airline#themes#metis#palette.accents = {'red': [ "${ui.userActionNeeded}" , "" , "" , "" ]}
...
if &background ==# "light"
${airlineBlock(Metis.themes.light)}
else
${airlineBlock(Metis.themes.dark)}
endif`;
}
